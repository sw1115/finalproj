...
```
The optimal neural network models here can give us the accuracy of 0.54.  
...
```{r final}
final <-unigram_testing %>%
  cbind(rfc_uni_100_pred) %>%
  cbind(knn_uni_final_pred) %>%
  cbind(nn_uni_final_pred)

final <- final[, c(232, 233, 234, 235)]
```
